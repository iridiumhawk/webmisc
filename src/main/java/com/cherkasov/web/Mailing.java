...
public class Mailing {
    ...
    public static void main(String[] args) {
        Mailing solution = new Mailing();
        solution.sendMail("test@gmail.com", "pass", "test@mail.ru");
...
//            String mytxt = "Another one test message from java!!";
//            message.setContent(mytxt, "text/plain");
            setAttachment(message, "c:\\java\\test.txt");
