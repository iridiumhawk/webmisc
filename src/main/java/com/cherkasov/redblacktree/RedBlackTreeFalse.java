...
public class RedBlackTreeFalse {
...
//???????
    ...
    private static Node rotateWithLeftNode(Node element) {
    ...
    private static Node rotateWithRightNode(Node element) {
        Node left = element.left;
        element.left = left.right;
        left.right = element;
        return left;
